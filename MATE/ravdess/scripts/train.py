...
def main():
    ...
    ap.add_argument("--config", default="audio_whisper.yaml", help="expert config yaml")
    ap.add_argument("--dataset", default="configs/datasets/ravdess.yaml", help="dataset config yaml")
