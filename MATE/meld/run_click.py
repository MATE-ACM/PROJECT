...
# =========================
CONFIG = {
    "dataset_yaml": "configs/datasets/meld.yaml",
    ...
    "expert_yamls": [
        # ======== openface video ========
        "configs/experts/whisper/audio_whisper_cnn_attention.yaml",
        ...
        #"configs/experts/hsemotion/video_hsemotion_BiGRU.yaml",
        ...
        #"configs/experts/A+T/wavlm_txt_lmf.yaml",
        #"configs/experts/A+T/whisper_txt_lmf.yaml",
...
def _resolve_yaml_path(p: str) -> str:
    ...
    hits = glob.glob(os.path.join("configs", "**", bn), recursive=True)
