...
class VideoNpyDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        # Preferred convention in this repo:
        #   <feat_root>/<utt_id>.<ext>
        # For migration convenience, we also try a couple speaker-folder fallbacks
        # (some older scripts saved per-speaker subdirs).
        cand_ids = [utt_id]
